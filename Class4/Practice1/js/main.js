...
const favoriteBreed = prompt("What is your favorite breed of dog?")
const randomBreed = breeds[Math.floor(Math.random() * breeds.length)];

var responseString = "Your favorite breed is " + favoriteBreed + "? Mine is " + randomBreed + "! ";

if (favoriteBreed.toLowerCase() == randomBreed.toLowerCase()) {
  alert(responseString + "We're besties!");
} else {
  alert(responseString + "You're wrong!");
}
